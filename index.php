...
<div class="page-loader position-fixed z-index-9999 w-100 bg-white vh-100">
	<div class="d-flex justify-content-center y-middle position-relative">
	  <div class="spinner-border" role="status">
		<span class="sr-only" style="background-image:url('images/roomlink (2).png');background-repeat:no-repeat;)"><img src="images/" alt=""></span>
	  </div>
	</div>
</div> 
<!--	Page Loader  -->
    ...
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">Discover Your</span><br>
                            Perfect Accomodation</h1>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <div class="left-arrow"><i class="flaticon-rent text-success flat-medium" aria-hidden="true"></i></div>
                            <h5 class="text-secondary mt-5 mb-4">Search</h5>
                            <p>Simply search the campus you are studying at to find your Accomodation</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            <div class="bg-success text-white rounded-circle position-absolute z-index-9">2</div>
                            <div class="left-arrow"><i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i></div>
                            <h5 class="text-secondary mt-5 mb-4">Compare</h5>
                            <p>Compare the apartments and choose the one that best suits you</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            <div class="bg-success text-white rounded-circle position-absolute z-index-9">3</div>
                            <div><i class="flaticon-list text-success flat-medium" aria-hidden="true"></i></div>
                            <h5 class="text-secondary mt-5 mb-4">Reserve</h5>
                            <p>Simply Reserve your desired accomodation </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Latest Property</h2>
                    </div>
                    <!--- <div class="col-md-6">
                    ...
                    <div class="col-md-12" style="box-shadow: 2px black">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>R<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                                            </div>
		...
		<!--	How it works -->
         <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Popular Destinations</h2></div>
                </div>
                <div class="col-lg-12">
                    <div class="row">
