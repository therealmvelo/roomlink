            ...
            <div class="container">
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <!--div class="bg-success d-table px-3 py-2 rounded text-white text-capitalize">For// echo $row['5'];?></div-->
                    ...
                    <div class="col-lg-4">
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-md-50">Leave a review</h4>
