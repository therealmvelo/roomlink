    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">property listing</h2>
                        </div>
					</div>
									...
									<?php echo $msg; ?>
										...
										<div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Visitors Allowed : </span>No</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Wi-fi : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Sharing : </span>Yes</li>
													...
													<div class="col-md-4">
														...
														<li class="mb-3"><span class="text-secondary font-weight-bold">Fence : </span>Yes</li>	
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Elecricity Backup : </span>No</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">CCTV : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Water Tank : </span>Yes</li>
														</ul>
													</div>
												<!---feature area end---->
											</textarea>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Front View</label>
													<div class="col-lg-9">
														<input class="form-control" name="aimage" type="file" required="">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Side View</label>
													<div class="col-lg-9">
														<input class="form-control" name="aimage2" type="file" required="">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Interior View</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Roof Image</label>
													<div class="col-lg-9">
														<input class="form-control" name="aimage1" type="file" required="">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Fence</label>
													<div class="col-lg-9">
