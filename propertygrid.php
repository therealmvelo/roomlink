                ...
                <div class="row">
					...
					<div class="col-lg-8">
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and type='{$type}'and city='{$city}'";
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-right text-secondary position-relative pb-4 mb-4">Recently Added Property</h4>
